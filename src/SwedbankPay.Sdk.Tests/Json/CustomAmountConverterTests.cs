...
namespace SwedbankPay.Sdk.Tests.Json
{
    ...
    {
        private long expectedAmount = 100;
        ...
        {
            //ARRANGE
            var orderItem = new OrderItem("Test", "Test",OrderItemType.Product, "MobilePhone",3, "pcs", Amount.FromDecimal(2), 0, Amount.FromDecimal(1), Amount.FromDecimal(2));
