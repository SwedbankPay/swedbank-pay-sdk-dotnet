...
namespace SwedbankPay.Sdk.Tests.PaymentTests
{
    public class CardPaymentTests : ResourceTestsBase
    {
        ...
        {
            var creditCardPayment = await this.Sut.GetCreditCardPayment(
        ...
        public async Task CreateVerifyPayment_ShouldReturnPayment()
        {
            ...
            var creditCardPayment = await this.Sut.CreateCreditCardPayment(paymentRequest, PaymentExpand.All);
