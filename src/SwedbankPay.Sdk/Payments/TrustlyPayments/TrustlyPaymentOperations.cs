...
namespace SwedbankPay.Sdk.Payments.TrustlyPayments
{
    public class TrustlyPaymentOperations : OperationsBase
    {
                ...
                switch (httpOperation.Rel.Value)
                {
                    ...
                    case PaymentResourceOperations.CreateSale:
                        CreateSale = async payload =>
                            await client.SendAsJsonAsync<TrustlyPaymentSaleResponse>(httpOperation.Method, httpOperation.Href, payload);
                        break;
        ...
        public Func<TrustlyPaymentSaleRequest, Task<TrustlyPaymentSaleResponse>> CreateSale { get; }
