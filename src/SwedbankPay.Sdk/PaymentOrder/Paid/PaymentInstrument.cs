...
public class PaymentInstrument : TypeSafeEnum<PaymentInstrument>
	{
        ...
        public static implicit operator PaymentInstrument?(string? instrument)
        {
            ...
            return instrument switch
            {
                ...
                "Invoice-PayExFinancingNo" => InvoicePayExFinancingNo,
                "Invoice-PayExFinancingSe" => InvoicePayExFinancingSe,
                "Invoice-PayMonthlyInvoiceSe" => InvoicePayMonthlyInvoiceSe,
                "CreditAccount-CreditAccountNo" => CreditAccountCreditAccountNo,
                "CreditAccount-CreditAccountSe" => CreditAccountCreditAccountSe,
                "ApplePay" => ApplePay,
                "GooglePay" => GooglePay,
