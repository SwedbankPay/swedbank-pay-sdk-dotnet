namespace SwedbankPay.Sdk.PaymentOrders
{
    ...
    public sealed class AccountPwdChangeIndicator : TypeSafeEnum<AccountPwdChangeIndicator, string>
    {
        ...
        public static readonly AccountPwdChangeIndicator ChangedDuringTransaction = new AccountPwdChangeIndicator(nameof(ChangedDuringTransaction), "02");
        public static readonly AccountPwdChangeIndicator LessThanThirtyDays = new AccountPwdChangeIndicator(nameof(LessThanThirtyDays), "03");
