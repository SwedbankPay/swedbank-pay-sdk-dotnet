...
namespace SwedbankPay.Sdk.PaymentInstruments.Invoice
{
    ...
    public class InvoicePaymentRequest
    {
        ...
        /// <param name="language">The payers preferred <seealso cref="Language"/>.</param>
        ...
        public InvoicePaymentRequest(Operation operation,
                                     ...
                                     InvoiceType invoiceType) : this(operation, intent, currency, prices, description, null, language, urls, payeeInfo, invoiceType)
        {
        }
