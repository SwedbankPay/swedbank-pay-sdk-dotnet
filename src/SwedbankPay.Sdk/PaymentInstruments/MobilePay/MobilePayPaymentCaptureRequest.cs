namespace SwedbankPay.Sdk.PaymentInstruments.MobilePay
{
    ...
    public class MobilePayPaymentCaptureRequest
    {
        ...
        /// </summary>
        /// <param name="amount">The <seealso cref="Sdk.Amount"/> to capture for this payment.</param>
        /// <param name="vatAmount">The <seealso cref="Sdk.Amount"/> to capture as VAT for this payment.</param>
