...
public sealed class AccountChangeIndicator : TypeSafeEnum<AccountChangeIndicator>
{
    ...
    /// </summary>
    public static readonly AccountChangeIndicator LessThanThirtyDays =
        new AccountChangeIndicator(nameof(LessThanThirtyDays), "02");

    /// <summary>
    /// Account details was last changed between thirty to sixty days ago.
    /// </summary>
    public static readonly AccountChangeIndicator ThirtyToSixtyDays =
        new AccountChangeIndicator(nameof(ThirtyToSixtyDays), "03");

    /// <summary>
    /// Account details last changed more than sixty days ago.
    /// </summary>
    public static readonly AccountChangeIndicator MoreThanSixtyDays =
        new AccountChangeIndicator(nameof(MoreThanSixtyDays), "04");
