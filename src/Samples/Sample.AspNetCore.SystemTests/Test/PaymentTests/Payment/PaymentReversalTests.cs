...
namespace Sample.AspNetCore.SystemTests.Test.PaymentTests.Payment
{
    public class PaymentReversalTests : Base.PaymentTests
    {
        ...
        public async Task Payment_Card_Reversal(Product[] products, PayexInfo payexInfo)
        {
            ...
            var order = await SwedbankPayClient.GetCreditCardPayment(paymentLink, PaymentExpand.All);
        ...
        public async Task Payment_Swish_Reversal(Product[] products, PayexInfo payexInfo)
        {
            ...
            var swishPayment = await SwedbankPayClient.GetSwishPayment(paymentLink, PaymentExpand.All);
            var counter = 0;
            ...
            {
                Thread.Sleep(1000);
                swishPayment = await SwedbankPayClient.GetSwishPayment(paymentLink, PaymentExpand.All);
                counter++;
            }
